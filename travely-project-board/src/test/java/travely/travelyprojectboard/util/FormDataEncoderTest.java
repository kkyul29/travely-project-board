package travely.travelyprojectboard.util;
...
import travely.travelyprojectboard.forEncoder;
...
@SpringBootTest(webEnvironment = SpringBootTest.WebEnvironment.NONE, classes = forEncoder.class)
